...
import {inappInterfaceGuide, inappAbout, inappBlocksGuide, inappPaintEditorGuide, inappThirdPartyNotices} from './src/entry/inapp.js';
...
function loadPage(page) {
    ...
    //	  root = '../';
		break;
	case 'inappThirdPartyNotices':
		// Human-readable license and attribution page
		preprocessAndLoadCss('style', 'inapp/style/third-party-notices.css');
		entryFunction = () => inappThirdPartyNotices();
		break;
	}
...
// The lobby injects in-app guide HTML into the current document. Expose the
// page loader explicitly because esbuild keeps each source module's scope
// separate in the browser bundle.
window.sjrLoadPage = loadPage;
