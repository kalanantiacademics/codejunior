...
export default class SVG2Canvas {
    ...
    static drawInCanvas (spr) {
        svgerror = false;
        var w = (spr.originalImg && (spr.originalImg.naturalWidth || spr.originalImg.width)) ||
                (spr.img && (spr.img.naturalWidth || spr.img.width)) || spr.w || 100;
        var h = (spr.originalImg && (spr.originalImg.naturalHeight || spr.originalImg.height)) ||
                (spr.img && (spr.img.naturalHeight || spr.img.height)) || spr.h || 100;
