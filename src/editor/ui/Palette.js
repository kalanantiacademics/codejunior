...
export default class Palette {
    ...
    static openPaletteBalloon (obj, label) {
        ...
        // globalx/globaly return coordinates in the logical page space. The
        // balloon is appended to #frame, so convert them to frame-local
        // coordinates before positioning it. This matters when the frame is
        // centered or CSS-scaled in the browser.
        var frameX = globalx(frame);
        var frameY = globaly(frame);
        var dy = globaly(obj) - frameY - 36 * scaleMultiplier;
        ...
        var dx = ((globalx(obj) - frameX + (obj.offsetWidth / 2)) * window.devicePixelRatio) - (w / 2);
